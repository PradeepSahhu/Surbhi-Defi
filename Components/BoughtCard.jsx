    ...
    >
      ...
      <div className=" relative rounded-lg bg-black shadow-secondary-1">
        ...
        <div className="flex justify-center">
          <button className="px-10 py-2 bg-yellow-400 rounded-xl text-black my-3 hover:scale-90 transition-all duration-300">
            Bid
            <MdVideogameAsset className="inline-block m-2 text-2xl" />
          </button>
        </div>
      </div>
    </div>
